...
<style>
  ...
  position: relative;
  width: 100%;
  max-width: 800px;  /* search bar ko bara karne ke liye max-width badha do */
  margin: 0 auto 20px;
  padding: 0 15px;
}
...
.search-field {
  display: block;
  width: 100%;
  padding: 12px 50px 12px 45px; /* dono buttons ke liye jagah */
...
.mic-btn {
  right: 50px; /* mic search button ke left me */
}
...
.mic-btn ion-icon {
  ...
  <button class="mic-btn" type="button" id="micBtn" aria-label="Voice Search">
        ...
        -->
          ...
          -->
            ...
            <div class="product-main">
              ...
              <div
                class="product-grid"
                data-category="mens-accessories"
