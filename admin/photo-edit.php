                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="<?php echo $collections[$collection]; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Category</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="<?php echo $categories[$collection][$category]; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="number" step="0.01" class="form-control" name="original_price" value="<?php echo $product['originalPrice']; ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="hover_image" value="<?php echo $product['hoverImage']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="number" min="1" max="5" class="form-control" name="rating" value="<?php echo $product['rating']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Available Sizes (comma separated)</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="sizes" value="<?php echo implode(',', $product['sizes']); ?>" placeholder="S,M,L,XL">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Available Colors (comma separated)</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="colors" value="<?php echo implode(',', $product['colors']); ?>" placeholder="Black,Blue,Red">
                            </div>
                        </div>
                        <div class="form-group">
