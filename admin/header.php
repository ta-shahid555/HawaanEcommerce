					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="/HawaanEcommerce/assets/uploads/<?php echo $_SESSION['user']['photo']; ?>" class="user-image" alt="User Image">
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'settings.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="settings.php">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'service.php') ) {echo 'active';} ?>">
			          ...
			          <a href="customer.php">
						...
						<li class="treeview <?php if( ($cur_page == 'message.php') || ($cur_page == 'customer-add.php') || ($cur_page == 'customer-edit.php') ) {echo 'active';} ?>">
			          <a href="message.php">
			            <i class="fa fa-envelope"></i> <span>Contact Messages</span>
			          </a>
			        </li>
						<li class="treeview <?php if( ($cur_page == 'blogs.php') || ($cur_page == 'customer-add.php') || ($cur_page == 'customer-edit.php') ) {echo 'active';} ?>">
			          <a href="blogs.php">
			            <i class="fa fa-tv"></i> <span>Blogs Management</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'spin.php') ) {echo 'active';} ?>">
			          <a href="spin.php">
			            <i class="fa fa-spinner"></i> <span>Spin</span>
			          </a>
			        </li>
